...
examples/
  ...
  ex12_rigid_plate_display_fold_corotational.py  # correct architecture: RigidBodyPart exact Dirichlet BC (not RBE2) drives the plate + corotational Q4/J2 display + surface tie; includes sanity_report()/fold_success_verdict() wiring -- use this as the reference starting point
