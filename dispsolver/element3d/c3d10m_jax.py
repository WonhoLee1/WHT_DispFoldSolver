...
c3d10m_jax.py
=============
3D 10-Node Modified Quadratic Tetrahedron Element (C3D10 / C3D10M).
Provides quadratic interpolation for complex CAD geometries and contact surfaces.
"""
...
class Tetra10Element(SolidElement3D):
    """3D 10-Node Quadratic Tetrahedron Element (C3D10M)."""
